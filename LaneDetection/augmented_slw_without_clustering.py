...
# This uses ASL without clustering. Initial setup is similar to other asw lane detection code.
# This was written to see performance impact of introducing clustering. P.S. Clustering should increase performance as we reduce image size.
# Clustering is used to determine if lane is dashed or solid, Hence, this categorization of lanes is disabled in this program.
# Logic for split and merging is also disabled as it relies on categorization of lanes.
class Main:
    def __init__(self):
        ...
        self.straight_line_threshold = 200
        self.car_middle = 662
        ...
        # self.video_writer_output = VideoWriter("lab-test031302-output.mp4", 5, 1280, 720)
    ...
    def process_frame(self, frame, frame_number):
        ...
        image_debugger.show_image_grey("Pre-processed image", warped_pipeline_image)


        # COMMENTED OUT CLUSTERING LOGIC HERE.
        # # Pyr Down image
        ...
        clustered_image = np.where(warped_pipeline_image != 0, 1, 0)
        ...
        image_debugger.show_image_grey("Image with all lane points.", clustered_image)
        ...
        for index in range(start, end, step):
            ...
            if len(good_points_indexes) != 0:
                ...
                #     image_debugger_split.show_image("Output image with new solid line", output_image)
                ...
                #     image_debugger_split.show_image("Clustered image after solid lane filtering", clustered_image)
                #
                ...
                #             new_tracking_box = TrackingBox(3, 968, 460, 3, get_color(6))
                ...
                image_debugger_split.show_image("Output image with detected points", output_image)

                # Remove lane points detected in current lane, so next lane's sliding windows does not detect them again
                clustered_image[y_coordinates, x_coordinates] = 0
                image_debugger_split.show_image("Remaining points after removing detected line points", clustered_image)
